...
<head>
    ...
    <meta charset="utf-8"/>
    <title>楼宇经济管理系统 - 登录</title>

    <meta name="description" content="楼宇经济管理系统 |登录页面"/>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form id="validationRetrieveForm" method="post" action="#">
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="retrieveEmail" name="email" type="email"
                                                                   class="form-control" placeholder="邮箱"
                                                                   data-rel="tooltip" title="邮箱作为用户名"
                                            ...
                                            <div class="clearfix">
                                                <button id="retrieveButton" type="button"
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="email" name="email" type="email"
                                                                   class="form-control" placeholder="邮箱"
                                                                   data-rel="tooltip" title="邮箱用于登录和找回密码"
                                                                   data-placement="right"/>
															<i class="ace-icon fa fa-envelope"></i>
														</span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="birthday" name="birthday" type="text"
                                                                   class="form-control" placeholder="生日" readonly/>

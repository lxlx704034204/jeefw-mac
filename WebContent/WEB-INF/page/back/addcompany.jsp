    ...
    <div class="col-xs-12">
        <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-2">
                    <select id='legalpersoncertificatetypename' name="legalpersoncertificatetypename"
                            class="input-large">
                ...
                <div class="col-xs-2">
                    <input type="text" id="legalpersoncertificatenumber" placeholder="法人证件号码"
                           name="legalpersoncertificatenumber"
                           class="input-large">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-2">
                    <input type="text" id="naturalpersoninverstrate" placeholder="自然人投资比例"
                           name="naturalpersoninverstrate"
                           class="input-large">
                </div>
                <label class="col-xs-2 control-label no-padding-right"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-2">
                    <input type="text" id="permitestablishauthority" placeholder="批准设立机关"
                           name="permitestablishauthority"
                           class="input-large">
                </div>
            </div>

...
<div class="page-header">
    <h1>
        楼宇信息
        <small><i class="ace-icon fa fa-angle-double-right"></i>房产使用信息</small>
                ...
                <div class="widget-main no-padding">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group" style="height:60px;">
                                    ...
                                    <c:forEach items="${certificateTypeInfoList }" var="n">
                                        <c:choose>
                                            <c:when test="${info.userCertificateTypeName == n.certificateTypeName}">
                                                <option value="${n.certificateTypeName}"
                                                        selected>${n.certificateTypeName }</option>
                                            </c:when>
                                            <c:otherwise>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="usercertificatenumber" value="${info.userCertificateNumber }"
                                       name='usercertificatenumber' placeholder="使用者证件号码" class="input-large">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="height:60px;">
                            ...
                            <div class="col-xs-2">
                                <select id='usetype' name='usetype' class="usetype input-large">
                                    <option value='出租'  <c:if
                                            test="${info.useType  eq  '出租' }"> selected="selected"</c:if>>出租
                                    </option>
                                    <option value='正常自用' <c:if
                                            test="${info.useType  eq  '正常自用' }"> selected="selected"</c:if>>正常自用
                                    </option>
                                    <option value='无租使用' <c:if
                                            test="${info.useType  eq  '无租使用' }"> selected="selected"</c:if>>无租使用
                                    </option>
                                    <option value='承典' <c:if
                                            test="${info.useType  eq  '承典' }"> selected="selected"</c:if>>承典
                                    </option>
                                    <option value='融资租赁' <c:if
                                            test="${info.useType  eq  '融资租赁' }"> selected="selected"</c:if>>融资租赁
                                    </option>
                                    <option value='闲置' <c:if
                                            test="${info.useType  eq  '闲置' }"> selected="selected"</c:if>>闲置
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="usesize" value='${info.useSize }' name='usesize'
                                       placeholder="使用面积(:平方米)" class="input-large"/>
                            </div>
                            <label class="col-xs-2 control-label no-padding-right"
                            ...
                            <div class="col-xs-2">
                                <select id='userhousetaxed' name='userhousetaxed' class="input-large">
                                    <option <c:if test="${info.userHouseTaxed eq '是'}">selected="selected"</c:if>>是
                                    </option>
                                    <option <c:if test="${info.userHouseTaxed eq '否'}">selected="selected"</c:if>>否
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class='chuzu' <c:if test="${info.useType ne '出租'}">hidden</c:if>>
                            ...
                            <div class="form-group" style="height:60px;">
                                ...
                                <div class="col-xs-2">
                                    <input type="text" id="lessorname" value='${info.lessorName }' name='lessorname'
                                           placeholder="出租人姓名" class="input-large"/>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <select id='lessorcertificatetypename' name="lessorcertificatetypename"
                                            class="input-large">
                                        <c:forEach items="${certificateTypeInfoList }" var="n">
                                            <c:choose>
                                ...
                                <div class="col-xs-2">
                                    <input type="text" id="lessorcertificatenumber"
                                           value='${info.lessorCertificateNumber }' name='lessorcertificatenumber'
                                           placeholder="出租者证件号码" class="input-large">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <select id='taxtype' name='taxtype' class="input-large">
                                        <option value='个人出租住房'
                                                <c:if test="${info.taxType eq '个人出租住房'}">selected="selected"</c:if>>
                                            个人出租住房
                                        </option>
                                        <option value='其它房屋出租'
                                                <c:if test="${info.taxType eq '其它房屋出租'}">selected="selected"</c:if>>
                                            其它房屋出租
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <input type="text" id="yearlyrental" value='${info.yearlyRental }'
                                           name='yearlyrental' placeholder="年租金收入(:元)" class="input-large"/>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <select id='lessorhousetaxed' name='lessorhousetaxed' class="input-large">
                                        <option value='是'
                                                <c:if test="${info.lessorHouseTaxed eq '是'}">selected="selected"</c:if>>
                                            是
                                        </option>
                                        <option value='否'
                                                <c:if test="${info.lessorHouseTaxed eq '否'}">selected="selected"</c:if>>
                                            否
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class='ziyong' <c:if test="${info.useType=='出租'}">hidden</c:if>>
                            ...
                            <div class="form-group" style="height:60px;">
                                ...
                                <div class="col-xs-2">
                                    <input type="text" id="originalvalue" value='${info.orignalValue }'
                                           name='originalvalue' placeholder="房产原值" class="input-large"/>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <input type="text" id="taxfreevalue" value="${info.taxFreeValue }"
                                           name='taxfreevalue' placeholder="免税原值" class="input-large"/>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <select id='taxtype' name='taxtype' class="input-large">
                                        <option value='生产用房'
                                                <c:if test="${info.taxType eq '生产用房'}">selected="selected"</c:if>>生产用房
                                        </option>
                                        <option value='营业用房'
                                                <c:if test="${info.taxType eq '营业用房'}">selected="selected"</c:if>>营业用房
                                        </option>
                                        <option value='办公用房'
                                                <c:if test="${info.taxType eq '办公用房'}">selected="selected"</c:if>>办公用房
                                        </option>
                                        <option value='职工用房'
                                                <c:if test="${info.taxType eq '职工用房'}">selected="selected"</c:if>>职工用房
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="datebegin" value="${info.dateBegin }" name='datebegin'
                                       placeholder="有效期起" class="input-large" readonly/>
                            </div>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="dateend" value="${info.dateEnd }" name='dateend'
                                       placeholder="有效期止" class="input-large" readonly/>
                            </div>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="comment" value="${info.comment }" name='comment' placeholder="备注"
                                       class="input-large"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="taxdeadline" value='${info.taxDeadline }' name='taxdeadline'
                                       placeholder="纳税期限" class="input-large" readonly/>
                            </div>
                            <label class="col-xs-2 control-label no-padding-right"
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="taxyear" value='${info.taxYear }' name='taxyear'
                                       placeholder="年纳税额" class="input-large"/>
                            </div>
                        </div>
            ...
            <div class="widget-main no-padding">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="usercertificatenumber" name='usercertificatenumber'
                                   placeholder="使用者证件号码" class="input-large">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <select id='usetype' name='usetype' class="usetype input-large">
                                <option value='出租' <c:if test="${info.usetype eq '出租'}"> selected="selected"</c:if>>出租
                                </option>
                                <option value='正常自用' <c:if test="${info.usetype eq '正常自用'}"> selected="selected"</c:if>>
                                    正常自用
                                </option>
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="usesize" name='usesize' placeholder="使用面积(:平方米)"
                                   class="input-large"/>
                        </div>
                        <label class="col-xs-2 control-label no-padding-right"
                               for="userhousetaxed">使用者征收房产税<font color="red">*</font>
                    ...
                    <div class='chuzu'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="lessorname" name='lessorname' placeholder="出租人姓名"
                                       class="input-large"/>
                            </div>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="lessorcertificatenumber" name='lessorcertificatenumber'
                                       placeholder="出租者证件号码" class="input-large">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="yearlyrental" name='yearlyrental' placeholder="年租金收入(:元)"
                                       class="input-large"/>
                            </div>
                    ...
                    <div class='ziyong'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="originalvalue" name='originalvalue' placeholder="房产原值"
                                       class="input-large"/>
                            </div>
                            ...
                            <div class="col-xs-2">
                                <input type="text" id="taxfreevalue" name='taxfreevalue' placeholder="免税原值"
                                       class="input-large"/>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="datebegin" name='datebegin' placeholder="有效期起" class="input-large"
                                   readonly/>
                        </div>
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="dateend" name='dateend' placeholder="有效期止" class="input-large"
                                   readonly/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="text" id="taxdeadline" name='taxdeadline' placeholder="纳税期限"

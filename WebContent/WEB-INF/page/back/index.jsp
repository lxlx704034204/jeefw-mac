...
<div id="navbar" class="navbar navbar-default">
    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="${contextPath}/sys/sysuser/home#page/homepage" class="navbar-brand">
                <small>
                    <i class="fa fa-leaf"></i>楼宇经济管理系统
                </small>
            </a>
            <!-- /section:basics/navbar.layout.brand -->
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="${contextPath}/static/assets/avatars/user.jpg"
                             alt="Jason's Photo"/>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            <c:forEach var="subAuthorityList" items="${authority.subAuthorityList}">
                                <li class="">
                                    <a data-url="<c:out value='${subAuthorityList.dataUrl}'/>"
                                       href="home#<c:out value='${subAuthorityList.dataUrl}'/>">
                                        <i class="<c:out value='${subAuthorityList.menuClass}'/>"></i><c:out
                                            value="${subAuthorityList.menuName}"/>
                                    </a>
                                    <b class="arrow"></b>
                                </li>
                            </c:forEach>

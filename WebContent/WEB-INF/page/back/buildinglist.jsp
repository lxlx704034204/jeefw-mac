            ...
            <table id="queryBuildingTable"
                ...
                <c:forEach items="${buildingInfoList }" var="n">
                    <tr>
                        ...
                        <td>
                            <a href='${contextPath}/sys/sysuser/home#page/roomnav/${n.id}'
                               id='b1'>${ n.buildingName}</a>
                        </td>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='buildingsourcenumber' name="buildingsourcenumber"
                                           placeholder="房源编号"
                                           class="input-large">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='propertycertificatenumber' name="propertycertificatenumber"
                                           placeholder="产权证书号"
                                           class="input-large">
                                </div>
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='groundsourcenumber' name="groundsourcenumber"
                                           placeholder="土地税源编号"
                                           class="input-large">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='housepropertynumber' name="housepropertynumber"
                                           placeholder="房产证书持有人识别号"
                                           class="input-large">
                                </div>
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='housepropertyname' name="housepropertyname"
                                           placeholder="房产证书持有人名称"
                                           class="input-large">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <select id='housecertificatetypename' name="housecertificatetypename"
                                            class="input-large">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" id='housecertificatetypenumber' name="housecertificatetypenumber"
                                           placeholder="房产证书持有人证件号码"
                                           class="input-large">
                                </div>
                            </div>
                            <div class="form-group">

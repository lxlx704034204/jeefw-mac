...
!function (a, b) {
    var c = function (c, d) {
        ...
        var m = this, n = a.extend({}, a.fn.ace_scroll.defaults, d);
        this.size = 0, this.lock = !1, this.lock_anyway = !1, this.$element = a(c), this.element = c;
        var o, p, q, r, s, t, u = !0, v = !1, w = !1, x = !1, y = null, z = null, A = null, B = null, C = null, D = null, E = null, F = 0, G = 0, H = 0, I = 0, J = !0, K = !1, L = "", M = !1, N = 0, O = 1, P = !1, Q = !1, R = "onmouseup"in window ? window : "html", S = n.dragEvent || !1, T = d.scrollEvent || !1, U = n.detached || !1, V = n.updatePos || !1, W = n.hideOnIdle || !1, X = n.hideDelay || 1500, Y = !1, Z = n.observeContent || !1, $ = 0, _ = !0;
        this.create = function (b) {
            if (!x) {
                ...
                U ? c = a('<div class="scroll-track scroll-detached"><div class="scroll-bar"></div></div>').appendTo("body") : (this.$element.wrapInner('<div class="scroll-content" />'), this.$element.prepend('<div class="scroll-track"><div class="scroll-bar"></div></div>')), y = this.$element, U || (y = this.$element.find(".scroll-content").eq(0)), u || y.wrapInner("<div />"), z = y.get(0), U ? (A = c, l()) : A = this.$element.find(".scroll-track").eq(0), B = A.find(".scroll-bar").eq(0), C = A.get(0), D = B.get(0), E = D.style, u || A.addClass("scroll-hz"), n.styleClass && (L = n.styleClass, A.addClass(L), M = !!L.match(/scroll\-left|scroll\-top/)), 0 == N && (A.show(), k()), A.hide(), A.on("mousedown", e), B.on("mousedown", f), y.on("scroll", function () {
                    ...
                    if (!v) {
                        if (i(!0), !w)return !m.lock_anyway;
                        Q && (Q = !1, a("html").off(".ace_scroll"), a(R).off(".ace_scroll"), S && m.$element.trigger("drag.end")), b.deltaY = b.deltaY || 0;
                        var c = b.deltaY > 0 || b.originalEvent.detail < 0 || b.originalEvent.wheelDelta > 0 ? 1 : -1, d = !1, e = z[r], f = z[s];
                ...
                if (d) {
                    ...
                    this.$element.on(h + ".ace_scroll", function (a) {
                        ...
                        if (i(!0), !w)return void(a.retval.cancel = this.lock_anyway);
    ...
    var c = function (b, c) {
        var d = a.extend({}, a.fn.ace_colorpicker.defaults, c), e = a(b), f = "", g = "", h = null, i = [];
        ...
        }).after('<div class="dropdown dropdown-colorpicker">		<a data-toggle="dropdown" class="dropdown-toggle" ' + (d.auto_pos ? 'data-position="auto"' : "") + ' href="#"><span class="btn-colorpicker" style="background-color:' + g + '"></span></a><ul class="dropdown-menu' + (d.caret ? " dropdown-caret" : "") + (d.pull_right ? " dropdown-menu-right" : "") + '">' + f + "</ul></div>");
    ...
    var c = "multiple"in document.createElement("INPUT"), d = "FileList"in window, e = "FileReader"in window, f = "File"in window, g = function (b, c) {
        var d = this;
        this.settings = a.extend({}, a.fn.ace_file_input.defaults, c), this.$element = a(b), this.element = b, this.disabled = !1, this.can_reset = !0, this.$element.off("change.ace_inner_call").on("change.ace_inner_call", function (a, b) {
            return d.disabled || b === !0 ? void 0 : i.call(d)
        });
        var e = this.$element.closest("label").css({display: "block"}), f = 0 == e.length ? "label" : "span";
        this.$element.wrap("<" + f + ' class="ace-file-input" />'), this.apply_settings(), this.reset_input_field()
    };
    g.error = {
        FILE_LOAD_FAILED: 1,
        IMAGE_LOAD_FAILED: 2,
    ...
    a.fn.aceFileInput = a.fn.ace_file_input = function (c, d) {
        ...
        return e === b ? f : e
    }, a.fn.aceFileInput.defaults = a.fn.ace_file_input.defaults = {
        style: !1,
        no_file: "No File ...",
    ...
    a.fn.aceTree = a.fn.ace_tree = function (b) {
        ...
        return c = a.extend({}, c, b), this.each(function () {
            var b = a(this);
            b.addClass("tree").attr("role", "tree"), b.html('<li class="tree-branch hide" data-template="treebranch" role="treeitem" aria-expanded="false">				<div class="tree-branch-header">					<span class="tree-branch-name">						<i class="icon-folder ' + c["close-icon"] + '"></i>						<span class="tree-label"></span>					</span>				</div>				<ul class="tree-branch-children" role="group"></ul>				<div class="tree-loader" role="alert">' + c.loadingHTML + '</div>			</div>			<li class="tree-item hide" data-template="treeitem" role="treeitem">				<span class="tree-item-name">				  ' + (null == c["unselected-icon"] ? "" : '<i class="icon-item ' + c["unselected-icon"] + '"></i>') + '				  <span class="tree-label"></span>				</span>			</li>'), b.addClass(1 == c.selectable ? "tree-selectable" : "tree-unselectable"), b.tree(c)
        }), this
    }
}(window.jQuery), function (a) {
    ...
    function c(b, c) {
        var e = a(b), f = "right", g = !1, h = "", i = !1, j = {};
        j.fixed = c.fixed || "true" == e.attr("data-fixed"), j.dark = c.background || "true" == e.attr("data-background"), j.offset = c.offset || "true" == e.attr("data-offset"), j.no_scroll = !c.body_scroll || "false" == e.attr("data-body-scroll"), j.transition = c.transition !== !1 && "false" !== e.attr("data-transition"), j.scroll_style = c.scroll_style || (j.dark ? "scroll-white" : "scroll-dark") + " no-track";
        var k = e.find(".modal-dialog"), l = e.find(".modal-content");
        this.initiate = function () {
            b.className = b.className.replace(/(\s|^)aside\-(right|top|left|bottom)(\s|$)/gi, "$1$3"), f = c.placement || e.attr("data-placement"), f = f ? a.trim(f.toLowerCase()) : "right", h = c.backdrop || e.attr("data-backdrop"), /right|top|left|bottom/.test(f) || (f = "right"), e.attr("data-placement", f), e.addClass("aside-" + f), /right|left/.test(f) ? (g = !0, e.addClass("aside-vc")) : e.addClass("aside-hz"), j.fixed && e.addClass("aside-fixed"), j.dark && e.addClass("aside-dark"), j.offset && e.addClass("navbar-offset"), j.transition || e.addClass("transition-off"), e.addClass("aside-hidden"), this.insideContainer(), k = e.find(".modal-dialog"), l = e.find(".modal-content"), j.no_scroll && e.on("mousewheel.aside DOMMouseScroll.aside touchmove.aside pointermove.aside", function (b) {
                return a.contains(l[0], b.target) ? void 0 : (b.preventDefault(), !1)
            }), h === !1 || "false" === h ? e.addClass("no-backdrop") : "invisible" === h && (i = !0)
        }, this.show = function () {
            e.css("position", "fixed").removeClass("aside-hidden")
        }, this.hide = function () {
            m(), ace.vars.transition && !e.hasClass("fade") && e.one("bsTransitionEnd", function () {
                e.addClass("aside-hidden"), e.css("position", "")
            }).emulateTransitionEnd(350)
        }, this.shown = function () {
            if (m(), a("body").removeClass("modal-open").css("padding-right", ""), i)try {
                e.data("bs.modal").$backdrop.css("opacity", 0)
            } catch (b) {
            }
            var c = g ? l.height() : k.height();
            ace.vars.touch ? l.addClass("overflow-scroll").css("max-height", c + "px") : l.hasClass("ace-scroll") || l.ace_scroll({
                size: c,
                reset: !0,
                mouseWheelLock: !0,
                lockAnyway: j.no_scroll,
                styleClass: j.scroll_style,
                observeContent: !0,
                hideOnIdle: !ace.vars.old_ie,
                hideDelay: 1500
            }), d.off("resize.modal.aside").on("resize.modal.aside", function () {
                if (ace.vars.touch)l.css("max-height", (g ? l.height() : k.height()) + "px"); else {
                    l.ace_scroll("disable");
                    var a = g ? l.height() : k.height();
                    l.ace_scroll("update", {size: a}).ace_scroll("enable").ace_scroll("reset")
                }
            }).triggerHandler("resize.modal.aside")
        }, this.hidden = function () {
            d.off(".aside"), (!ace.vars.transition || e.hasClass("fade")) && (e.addClass("aside-hidden"), e.css("position", ""))
        }, this.insideContainer = function () {
            var b = a(".main-container"), c = e.find(".modal-dialog");
            if (c.css({right: "", left: ""}), b.hasClass("container")) {
                var h = !1;
                1 == g && (c.css(f, parseInt((d.width() - b.width()) / 2)), h = !0), h && ace.vars.firefox && ace.helper.redraw(b[0])
            }
        }, this.flip = function () {
            var a = {right: "left", left: "right", top: "bottom", bottom: "top"};
            e.removeClass("aside-" + f).addClass("aside-" + a[f]), f = a[f]
        };
        var m = function () {
            var a = e.find(".aside-trigger");
            if (0 != a.length) {
                a.toggleClass("open");

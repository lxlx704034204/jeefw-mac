+function (t) {
    ...
    function e(e) {
        return this.each(function () {
            var i = t(this), s = i.data("bs.tooltip"), n = "object" == typeof e && e, r = n && n.selector;
            (s || "destroy" != e) && (r ? (s || i.data("bs.tooltip", s = {}), s[r] || (s[r] = new o(this, n))) : s || i.data("bs.tooltip", s = new o(this, n)), "string" == typeof e && s[e]())
        })
    }
    ...
    o.VERSION = "3.3.1", o.TRANSITION_DURATION = 150, o.DEFAULTS = {
        ...
        for (var s = this.options.trigger.split(" "), n = s.length; n--;) {
            ...
            if ("click" == r)this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this)); else if ("manual" != r) {
                var a = "hover" == r ? "mouseenter" : "focusin", p = "hover" == r ? "mouseleave" : "focusout";
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var a = "function" == typeof this.options.placement ? this.options.placement.call(this, n[0], this.$element[0]) : this.options.placement, p = /\s?auto?\s?/i, l = p.test(a);
            l && (a = a.replace(p, "") || "top"), n.detach().css({
                top: 0,
                left: 0,
                display: "block"
            ...
            if (l) {
                var d = a, u = this.options.container ? t(this.options.container) : this.$element.parent(), g = this.getPosition(u);
                a = "bottom" == a && h.bottom + c > g.bottom ? "top" : "top" == a && h.top - c < g.top ? "bottom" : "right" == a && h.right + f > g.width ? "left" : "left" == a && h.left - f < g.left ? "right" : a, n.removeClass(d).addClass(a)
            }
            ...
            t.support.transition && this.$tip.hasClass("fade") ? n.one("bsTransitionEnd", m).emulateTransitionEnd(o.TRANSITION_DURATION) : m()
        }
        ...
        "top" == o && l != n && (e.top = e.top + n - l);
        var h = this.getViewportAdjustedDelta(o, e, p, l);
        h.left ? e.left += h.left : e.top += h.top;
        var f = /top|bottom/.test(o), c = f ? 2 * h.left - s + p : 2 * h.top - n + l, d = f ? "offsetWidth" : "offsetHeight";
        ...
        return this.$element.trigger(r), r.isDefaultPrevented() ? void 0 : (n.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? n.one("bsTransitionEnd", i).emulateTransitionEnd(o.TRANSITION_DURATION) : i(), this.hoverState = null, this)
        ...
        e = e || this.$element;
        var o = e[0], i = "BODY" == o.tagName, s = o.getBoundingClientRect();
        ...
        if (/right|left/.test(t)) {
            var a = e.top - n - r.scroll, p = e.top + n - r.scroll + i;
            a < r.top ? s.top = r.top - a : p > r.top + r.height && (s.top = r.top + r.height - p)
        } else {
            var l = e.left - n, h = e.left + n + o;
            l < r.left ? s.left = r.left - l : h > r.width && (s.left = r.left + r.width - h)
        }
        return s

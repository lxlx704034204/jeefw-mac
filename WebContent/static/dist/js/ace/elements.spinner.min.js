(function ($, undefined) {
    function Ace_Spinner(element, options) {
        ...
        if (options.on_sides) {
            $element.before('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-down btn-xs ' + options.btn_down_class + '">						<i class="' + ace.vars["icon"] + options.icon_down + '"></i>					</button>				</div>').after('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up btn-xs ' + options.btn_up_class + '">						<i class="' + ace.vars["icon"] + options.icon_up + '"></i>					</button>				</div>');
            $parent_div.addClass("touch-spinner");
            $parent_div.css("width", width + "px")
        } else {
            $element.after('<div class="spinbox-buttons input-group-btn">					<button type="button" class="btn spinbox-up btn-xs ' + options.btn_up_class + '">						<i class="' + ace.vars["icon"] + options.icon_up + '"></i>					</button>					<button type="button" class="btn spinbox-down btn-xs ' + options.btn_down_class + '">						<i class="' + ace.vars["icon"] + options.icon_down + '"></i>					</button>				</div>');
    ...
    $.fn.ace_spinner = function (option, value) {
        ...
        var $set = this.each(function () {
            ...
            if (typeof option === "string") {
                retval = data._call(option, value)
            }
        });

(function ($, undefined) {
    ...
    function Sidebar(sidebar, options) {
        ...
        var duration = options.duration || ace.helper.intAttr(sidebar, "data-submenu-duration") || 300;
        ...
        var findToggleBtn = function () {
            ...
            if (toggle_btn.length == 0) {
                toggle_btn = $('.sidebar-collapse[data-target="#' + (self.$sidebar.attr("id") || "") + '"]')
            }
            if (toggle_btn.length != 0) {
        ...
        this.toggleMenu = function (toggle_btn, save) {
            ...
            try {
                ace.settings.sidebar_collapsed(sidebar, this.minimized, !(toggle_btn === false || save === false))
            } catch (e) {
                if (this.minimized) {
        ...
        this.toggleResponsive = function (toggle_btn) {
            ...
            if (!toggle_btn) {
                ...
                if (toggle_btn.length == 0) {
                    toggle_btn = $('.sidebar-expand[data-target="#' + (this.$sidebar.attr("id") || "") + '"]')
                }
                if (toggle_btn.length != 0) {
                    toggle_btn = toggle_btn[0]
                } else {
        ...
        this.is_collapsible = function () {
            var toggle;
            return (this.$sidebar.hasClass("navbar-collapse")) && ((toggle = $('.navbar-toggle[data-target="#' + (this.$sidebar.attr("id") || "") + '"]').get(0)) != null) && toggle.scrollHeight > 0
        };
        this.is_mobile_view = function () {
            var toggle;
            return ((toggle = $('.menu-toggler[data-target="#' + (this.$sidebar.attr("id") || "") + '"]').get(0)) != null) && toggle.scrollHeight > 0
        };
        this.$sidebar.on(ace.click_event + ".ace.submenu", ".nav-list", function (ev) {
            ...
            if (!link_element.hasClass("dropdown-toggle")) {
                if (ace.click_event == "tap" && minimized && link_element.get(0).parentNode.parentNode == nav_list) {
                    var text = link_element.find(".menu-text").get(0);
                    if (text != null && ev.target != text && !$.contains(text, ev.target)) {
                        ev.preventDefault();
                        return false
                    }
                }
            ...
            if ((minimized && parent_ul == nav_list) || (($sub.parent().hasClass("hover") && $sub.css("position") == "absolute") && !self.collapsible)) {
                return false
            }
        ...
        this.show = function (sub, $duration, wait) {
            ...
            var complete = function (ev, trigger) {
                ...
                $sub.css({"transition-property": "", "transition-duration": "", overflow: "", height: ""});
                if (trigger !== false) {
        ...
        this.hide = function (sub, $duration, wait) {
            ...
            $sub.css({height: sub.scrollHeight, overflow: "hidden", display: "block"}).parent().removeClass("open");
            sub.offsetHeight;
            if ($duration > 0) {
                $sub.css({
                    "height": 0,
        ...
        var sidebar_mobile_style = function () {
            this.mobile_style = 1;
            if (this.$sidebar.hasClass("responsive") && !$('.menu-toggler[data-target="#' + this.$sidebar.attr("id") + '"]').hasClass("navbar-toggle")) {
                this.mobile_style = 2
            } else {
        ...
        function update_vars() {
            ...
            this.minimized = (!this.collapsible && this.$sidebar.hasClass(minimized_menu_class)) || (this.mobile_style == 3 && this.mobile_view && this.$sidebar.hasClass(responsive_min_class));
    ...
    $(document).on(ace.click_event + ".ace.menu", ".menu-toggler", function (e) {
        var btn = $(this);

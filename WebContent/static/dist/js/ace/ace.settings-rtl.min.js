(function ($, undefined) {
    ...
    var switch_direction = function () {
        ...
        function applyChanges() {
            ...
            $body.toggleClass("rtl").find(".dropdown-menu:not(.datepicker-dropdown,.colorpicker)").toggleClass("dropdown-menu-right").end().find(".pull-right:not(.dropdown-menu,blockquote,.profile-skills .pull-right)").removeClass("pull-right").addClass("tmp-rtl-pull-right").end().find(".pull-left:not(.dropdown-submenu,.profile-skills .pull-left)").removeClass("pull-left").addClass("pull-right").end().find(".tmp-rtl-pull-right").removeClass("tmp-rtl-pull-right").addClass("pull-left").end().find(".chosen-select").toggleClass("chosen-rtl").next().toggleClass("chosen-rtl");
            ...
            $(".fa").each(function () {
                if (this.className.match(/ui-icon/) || $(this).closest(".fc-button").length > 0) {
                    return
                }
            ...
            if (rtl) {
                $(".scroll-hz").addClass("make-ltr").find(".scroll-content").wrapInner('<div class="make-rtl" />');
                $(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("changeDir", "right")
            } else {
                $(".scroll-hz").removeClass("make-ltr").find(".make-rtl").children().unwrap();

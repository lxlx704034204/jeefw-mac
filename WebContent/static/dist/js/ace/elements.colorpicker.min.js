(function ($, undefined) {
    var Ace_Colorpicker = function (element, option) {
            ...
            if (typeof index === "number") {
                ...
                if (typeof index === "string") {
                    ...
                    if (index == -1 && insert === true) {
                        color_array.push(color);
                        $("<option />").appendTo($element).val(color);
                        $('<li><a class="colorpick-btn" href="#"></a></li>').appendTo(dropdown).find("a").css("background-color", color).data("color", color);
        ...
        this.destroy = function () {
            $element.removeClass("hide").off("change.color").next().remove();
            color_array = []
        }
    };
    $.fn.ace_colorpicker = function (option, value) {
        ...
        var $set = this.each(function () {
            ...
            if (!data) {
                $this.data("ace_colorpicker", (data = new Ace_Colorpicker(this, options)))
            }
    ...
    $.fn.ace_colorpicker.defaults = {"pull_right": false, "caret": true, "auto_pos": true}
})(window.jQuery);
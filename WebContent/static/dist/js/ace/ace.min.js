...
jQuery(function ($) {
    ...
    function enableAjax() {
        if ($.fn.ace_ajax) {
            $("[data-ajax-content=true]").ace_ajax({
                "close_active": true, "content_url": function (hash) {
                    if (!hash.match(/^page\//)) {
                        return false
                    }
    ...
    function dropdownAutoPos() {
        $(document).on("click.dropdown.pos", '.dropdown-toggle[data-position="auto"]', function () {
            ...
            if (parseInt(offset.top + $(this).height()) + 50 > (ace.helper.scrollTop() + ace.helper.winHeight() - parent.find(".dropdown-menu").eq(0).height())) {
    ...
    function smallDeviceDropdowns() {
        ...
        function adjustNavbarDropdown() {
            ...
            if ($sub.css("position") == "fixed") {
                ...
                if (dropdown_content.length == 1) {
                    if (!ace.vars["touch"]) {
                        ...
                        dropdown_content.ace_scroll("disable").css("max-height", height - extra_parts).addClass("overflow-scroll")
                    }
                }
                ...
                if ($sub.hasClass("user-menu")) {
                    ...
                    if (user_info.length == 1 && user_info.css("position") == "fixed") {
                        ...
                        user_info.css({"left": "", "right": "", "top": "", "width": "", "max-width": "", "z-index": ""})
                    }
                }
            ...
            var self = this;
            $(window).off("resize.navbar.dropdown").one("resize.navbar.dropdown", function () {

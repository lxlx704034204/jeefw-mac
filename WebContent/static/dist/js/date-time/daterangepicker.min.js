    ...
    e.prototype = {
        constructor: e, setOptions: function (a, b) {
            ...
            if ("undefined" == typeof a.startDate && "undefined" == typeof a.endDate && d(this.element).is("input[type=text]")) {
                ...
                f = g = null, 2 == j.length ? (f = c(j[0], this.format), g = c(j[1], this.format)) : this.singleDatePicker && (f = c(i, this.format), g = c(i, this.format)), null !== f && null !== g && (this.startDate = f, this.endDate = g)
            }
            if ("object" == typeof a.ranges) {
                for (h in a.ranges)f = c(a.ranges[h][0]), g = c(a.ranges[h][1]), this.minDate && f.isBefore(this.minDate) && (f = c(this.minDate)), this.maxDate && g.isAfter(this.maxDate) && (g = c(this.maxDate)), this.minDate && g.isBefore(this.minDate) || this.maxDate && f.isAfter(this.maxDate) || (this.ranges[h] = [f, g]);
                var k = "<ul>";
            ...
            if ("function" == typeof b && (this.cb = b), this.timePicker || (this.startDate = this.startDate.startOf("day"), this.endDate = this.endDate.endOf("day")), this.singleDatePicker ? (this.opens = "right", this.container.addClass("single"), this.container.find(".calendar.right").show(), this.container.find(".calendar.left").hide(), this.timePicker ? this.container.find(".ranges .daterangepicker_start_input, .ranges .daterangepicker_end_input").hide() : this.container.find(".ranges").hide(), this.container.find(".calendar.right").hasClass("single") || this.container.find(".calendar.right").addClass("single")) : (this.container.removeClass("single"), this.container.find(".calendar.right").removeClass("single"), this.container.find(".ranges").show()), this.oldStartDate = this.startDate.clone(), this.oldEndDate = this.endDate.clone(), this.oldChosenLabel = this.chosenLabel, this.leftCalendar = {
                ...
                var l = this.container.find(".calendar.left"), m = this.container.find(".calendar.right");
            ...
            "string" == typeof a && (this.startDate = c(a, this.format)), "object" == typeof a && (this.startDate = c(a)), this.timePicker || (this.startDate = this.startDate.startOf("day")), this.oldStartDate = this.startDate.clone(), this.updateView(), this.updateCalendars(), this.updateInputText()
        }, setEndDate: function (a) {
            "string" == typeof a && (this.endDate = c(a, this.format)), "object" == typeof a && (this.endDate = c(a)), this.timePicker || (this.endDate = this.endDate.endOf("day")), this.oldEndDate = this.endDate.clone(), this.updateView(), this.updateCalendars(), this.updateInputText()
        }, updateView: function () {
            ...
            this.isShowing || (this.element.addClass("active"), this.container.show(), this.move(), this._outsideClickProxy = d.proxy(function (a) {
                this.outsideClick(a)
            }, this), d(document).on("mousedown.daterangepicker", this._outsideClickProxy).on("click.daterangepicker", "[data-toggle=dropdown]", this._outsideClickProxy).on("focusin.daterangepicker", this._outsideClickProxy), this.isShowing = !0, this.element.trigger("show.daterangepicker", this))
        }, outsideClick: function (a) {
            var b = d(a.target);
            b.closest(this.element).length || b.closest(this.container).length || b.closest(".calendar-date").length || this.hide()
        }, hide: function () {
            this.isShowing && (d(document).off("mousedown.daterangepicker").off("click.daterangepicker", "[data-toggle=dropdown]").off("focusin.daterangepicker"), this.element.removeClass("active"), this.container.hide(), this.startDate.isSame(this.oldStartDate) && this.endDate.isSame(this.oldEndDate) || this.notify(), this.oldStartDate = this.startDate.clone(), this.oldEndDate = this.endDate.clone(), this.isShowing = !1, this.element.trigger("hide.daterangepicker", this))
            ...
            var b = d(a.target).closest(".calendar"), c = b.hasClass("left"), e = parseInt(b.find(".hourselect").val(), 10), f = parseInt(b.find(".minuteselect").val(), 10);
            if (this.timePicker12Hour) {
                var g = b.find(".ampmselect").val();
                "PM" === g && 12 > e && (e += 12), "AM" === g && 12 === e && (e = 0)
            }
            if (c) {
                var h = this.startDate.clone();
                h.hour(e), h.minute(f), this.startDate = h, this.leftCalendar.month.hour(e).minute(f), this.singleDatePicker && (this.endDate = h.clone())
            } else {
                var i = this.endDate.clone();
                i.hour(e), i.minute(f), this.endDate = i, this.singleDatePicker && (this.startDate = i.clone()), this.rightCalendar.month.hour(e).minute(f)
            }
        ...
        }, buildCalendar: function (a, b, d, e, f) {
            var g, h = c([b, a]).daysInMonth(), i = c([b, a, 1]), j = c([b, a, h]), k = c(i).subtract(1, "month").month(), l = c(i).subtract(1, "month").year(), m = c([l, k]).daysInMonth(), n = i.day(), o = [];
            for (o.firstDay = i, o.lastDay = j, g = 0; 6 > g; g++)o[g] = [];
            var p = m - n + this.locale.firstDay + 1;
            p > m && (p -= 7), n == this.locale.firstDay && (p = m - 6);
            var q, r, s = c([l, k, p, 12, e]);
            for (g = 0, q = 0, r = 0; 42 > g; g++, q++, s = c(s).add(24, "hour"))g > 0 && q % 7 === 0 && (q = 0, r++), o[r][q] = s.clone().hour(d), s.hour(12), this.minDate && o[r][q].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && o[r][q].isBefore(this.minDate) && "left" == f && (o[r][q] = this.minDate.clone()), this.maxDate && o[r][q].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && o[r][q].isAfter(this.maxDate) && "right" == f && (o[r][q] = this.maxDate.clone());
            return o
            ...
            if (this.timePicker) {
                ...
                if (g += "</select> ", this.timePicker12Hour) {

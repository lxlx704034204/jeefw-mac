        ...
        init: function () {
            ...
            if ($("#site_statistics").size() != 0) {
                ...
                var plot_statistics = $.plot($("#site_statistics"), [{
                    data: pageviews,
                    label: "Unique Visits"
                }, {data: visitors, label: "Page Views"}], {
                    series: {
                        lines: {
                            show: true,
                            lineWidth: 2,
            ...
            if ($("#load_statistics").size() != 0) {
                ...
                var plot_statistics = $.plot($("#load_statistics"), [getRandomData()], {
                    ...
                    xaxis: {show: false},
                    colors: ["#e14e3d"],
                    grid: {tickColor: "#a8a3a3", borderWidth: 0}
                });
            ...
            if ($("#site_activities").size() != 0) {
                ...
                var plot_activities = $.plot($("#site_activities"), [{
                    ...
                    shadowSize: 0,
                    bars: {show: true, lineWidth: 0, fill: true, fillColor: {colors: [{opacity: 1}, {opacity: 1}]}}
                }], {
                    series: {bars: {show: true, barWidth: 0.9}},

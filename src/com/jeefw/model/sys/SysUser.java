...
public class SysUser extends SysUserParameter {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.id) && Objects.equal(this.userName, other.userName) && Objects.equal(this.sex, other.sex) && Objects.equal(this.email, other.email) && Objects.equal(this.phone, other.phone)
                && Objects.equal(this.birthday, other.birthday) && Objects.equal(this.departmentKey, other.departmentKey) && Objects.equal(this.password, other.password) && Objects.equal(this.role, other.role)
                && Objects.equal(this.status, other.status) && Objects.equal(this.lastLoginTime, other.lastLoginTime);
    }

    public int hashCode() {
        return Objects.hashCode(this.id, this.userName, this.sex, this.email, this.phone, this.birthday, this.departmentKey, this.password, this.role, this.status, this.lastLoginTime);
    }
